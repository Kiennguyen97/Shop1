...
@section('content')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                      <div class="img-box">
                        <img class="img-responsive img-mobile" src="{!!url('public/uploads/products/'.$data->images)!!}" onerror="this.src='public/default.jpg'" alt="{!!$data->name!!}">
                      </div>
                      <div class="img-slide">
                          ...
                          <div id="links">
                            @foreach($data->detail_img as $row)
                              <a href="{!!url('public/uploads/products/details/'.$row->images_url)!!}" title="{!!$data->name!!}" data-gallery>
                                  <img src="{!!url('public/uploads/products/details/'.$row->images_url)!!}" onerror="this.src='public/default.jpg'" alt="{!!$data->name!!}" width="30" height="40">
                              </a>
                            @endforeach                              
                          </div>
            ...
            <div class="thumbnail mobile">              
              <div class="bt">
                <div class="image-m pull-left">
                  <img class="img-responsive" src="{!!url('public/uploads/products/'.$row->images)!!}" onerror="this.src='public/default.jpg'" alt="{!!$row->name!!}">
                </div>
    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body no-padding">
       <a href="#" title=""><img src="{!!url('images/slides/thumbs/qc1.png')!!}" onerror="this.src='public/default.jpg'" alt="" width="100%" height="100%"> </a> <br>
        <a href="#" title=""><img src="{!!url('images/slides/thumbs/qc2.png')!!}" onerror="this.src='public/default.jpg'" alt="" width="100%" height="100%"> </a> <br>
        <a href="#" title=""><img src="{!!url('images/slides/thumbs/qc3.png')!!}" onerror="this.src='public/default.jpg'" alt="" width="100%" height="100%"> </a>
        <a href="#" title=""><img src="{!!url('images/slides/thumbs/qc4.png')!!}" onerror="this.src='public/default.jpg'" alt="" width="100%" height="100%"> </a>
        <a href="#" title=""><img src="{!!url('images/slides/thumbs/qc5.png')!!}" onerror="this.src='public/default.jpg'" alt="" width="100%" height="100%"> </a>
      </div>
    </div> <!-- /panel info 2  quản cáo 1          -->        
     <!-- /panel info 2  quản cáo 1          -->  
     <!-- fan pages myweb -->
