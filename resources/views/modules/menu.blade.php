 ...
 <style type="text/css">
   ...
   .branch:hover{
    ...
    <nav class="navbar navbar-default navbar-top" role="navigation" id="main-Nav" style="background-color: #4CAF50;margin-bottom: 5px;font-size: 13px;">
      <div class="container">  
        <div class="row">
             ...
             <span  class="visible-xs pull-right" style="font-size:20px;cursor:pointer; padding-right: 10px; padding-top: 8px; color: #FFFFFF;" >      
              <!-- Authentication Links -->
                @if (Auth::guest())
                    ...
                    <a href="#" data-toggle="modal" data-target="#login-modal" style="color:white;"> Đăng nhập </a> <a href="{{ url('/register') }}"  style="color:white;"> Đăng ký </a>
                @else  
            ...
            <ul class="nav navbar-nav">
             ...
             <li>
                <div style="width: 250px;margin-top: 10px;">
                  <form class="form-inline" action="{!!url('/tim-kiem/')!!}" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="submit" class="btn btn-default" type="button" id="searchBtn">Tìm</button>
                        </span>
                    </div>
                  </form>
                </div>
              ...
              <li class="dropdown">
                <a  class="dropdown-toggle" data-toggle="dropdown">
                  <span class="glyphicon glyphicon-align-justify"></span> Kho Hàng <b class="caret"></b></a>
                <ul class="dropdown-menu" style="right:0; left: auto; min-width: 120px;">
                  <li><a href="{!!url('/')!!}">Toàn quốc</a></li>
                  <li><a href="{!!url('/store/ha-noi')!!}">Hà Nội</a></li>
                  <li><a href="{!!url('/store/ho-chi-minh')!!}">Hồ Chí Minh</a></li>
                  <li><a href="{!!url('/store/hai-phong')!!}">Hải Phòng</a></li>
                </ul>
              </li>
              @if(isset($name_branch))
                    <li><a href="#" class="branch">{{ $name_branch }}</a></li>
              @endif
              <li class="dropdown">
