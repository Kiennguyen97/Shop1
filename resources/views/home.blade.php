...
@section('content')
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div style="padding: 10px 10px;border: 1px solid #f0f0f0;margin-bottom: 5px;background-color: #4CAF50;color: white;font-size: 18px;font-weight: bold;">
        <a style="color:white!important" href="{!!url('mobile')!!}">Điện thoại thông minh</a> </div> 
        <!-- danh muc dien thoai -->
        @if(count($mobile) == 0)
          <div style="font-size: 18px;font-weight: bold;padding: 10px 10px;text-align: center;border: 1px solid #f0f0f0;">Không có sản phẩm nào</div>
        @endif
            ...
            <div class="thumbnail mobile">              
              <div class="bt">
                <div class="image-m pull-left">
                  <img class="img-responsive" src="{!!url('public/uploads/products/'.$row->images)!!}" onerror="this.src='public/default.jpg'" alt="img responsive">
                </div>
        ...
        <!--========================== phan danh muc laptop   =========================================  -->
          <div id="laptop"></div>
          <div style="padding: 10px 10px;border: 1px solid #f0f0f0;margin-bottom: 5px;background-color: #4CAF50;color: white;font-size: 18px;font-weight: bold;">
        <a style="color:white!important" href="{!!url('laptop')!!}">Laptop</a></div> 
        @if(count($laptop) == 0)
          <div style="font-size: 18px;font-weight: bold;padding: 10px 10px;text-align: center;border: 1px solid #f0f0f0;">Không có sản phẩm nào</div>
        @endif
...
<!-- =============== danh muc may tinh ===================================== -->
        ...
        <div style="padding: 10px 10px;border: 1px solid #f0f0f0;margin: 5px 0px;background-color: #4CAF50;color: white;font-size: 18px;font-weight: bold;">
        <a style="color:white!important" href="{!!url('pc')!!}">Máy tính</a></div> 
        @if(count($pc) == 0)
          <div style="font-size: 18px;font-weight: bold;padding: 10px 10px;text-align: center;border: 1px solid #f0f0f0;">Không có sản phẩm nào</div>
        @endif
        @foreach($pc as $row)
