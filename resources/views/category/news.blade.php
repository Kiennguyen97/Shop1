    ...
    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 no-padding"> 
        <div class="fluid_container" style="height: 250px;">            
          <div class="camera_violet_skin" id="camera_wrap_1">
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc1.png')!!}" data-src="{!!url('public/images/slides/thumbs/qc1.png')!!}">
                <div class="camera_caption fadeFromBottom">
                    Sắm Apple giá tốt, Du lịch châu âu. <em>Event mua hàng Apple Tại Thế Giới Di Động</em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc2.png')!!}" data-src="{!!url('public/images/slides/thumbs/qc2.png')!!}">
                <div class="camera_caption fadeFromBottom">
                    Sony trả góp 0%, có cỏ hội trúng Tivi 4K <em> Dành cho sản phẩm sony Tại Thế Giới Di Động </em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc3.png')!!}" data-src="{!!url('public/images/slides/thumbs/qc3.png')!!}">
                <div class="camera_caption fadeFromBottom">
                    Galaxy J7 Prime - mua online thêm quà, <em> Dành cho Galaxy J7 Prime Tại Thế Giới Di Động </em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc4.png')!!}" data-src="{!!url('public/images/slides/thumbs/qc4.png')!!}">
                <div class="camera_caption fadeFromBottom">
                    Galaxy J7 Prime - mua online thêm quà, <em> Dành cho Galaxy J7 Prime Tại Thế Giới Di Động </em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc5.png')!!}" data-src="{!!url('public/images/slides/thumbs/qc5.png')!!}">
                <div class="camera_caption fadeFromBottom">
                     Galaxy J7 Prime - mua online thêm quà, <em> Dành cho Galaxy J7 Prime Tại Thế Giới Di Động </em>)
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc6.png')!!}" data-src="{!!url('public/images/slides/thumbs/qc6.png')!!}">
                <div class="camera_caption fadeFromBottom">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="panel panel-success">
            <div class="panel-body">
              ...
              <!-- hot new content -->              
                <div class="col-lg-6">
                  <img src="{!!url('public/uploads/news/'.$hot1->images)!!}" onerror="this.src='public/default.jpg'" alt="" height="200" width="100%">
                    ...
                    @foreach($data as $row)
                      <div class="col-lg-12 ">
                        ...
                        <div class="col-lg-3 no-padding">
                          <a href="{!!url('/tin-tuc/'.$row->id.'-'.$row->slug)!!}" title=""><img src="{!!url('uploads/news/'.$row->images)!!}" onerror="this.src='public/default.jpg'" alt="" width="80" height="80" style="padding-right:10px; padding-left: 0;"></a>
                        </div>
                      </div>
                    @endforeach                   
                  </div>                                     
              ...
              <div class="row">
                @foreach($all as $row)
                  <div class="col-lg-12 no-padding">
                    <hr>
                    <div class="col-lg-3">
                      <a href="{!!url('/tin-tuc/'.$row->id.'-'.$row->slug)!!}" title="{!!$row->slug!!}"><img src="{!!url('public//uploads/news/'.$row->images)!!}" alt="" onerror="this.src='public/default.jpg'" width="90%" height="99%"> </a>
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="tab-pane active" id="1">
              <ul class="li-menu-tab">
                ...
                @foreach($all as $row)
                  <div class="col-lg-12 no-padding">
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 no-padding">
                      <a href="{!!url('/tin-tuc/'.$row->id.'-'.$row->slug)!!}" title="{!!$row->title!!}"><img src="{!!url('public/uploads/news/'.$row->images)!!}" alt="{!!$row->images!!}" onerror="this.src='public/default.jpg'" width="99%" height="99%"> </a>
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 no-padding">
