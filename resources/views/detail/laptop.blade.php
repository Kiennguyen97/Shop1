                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                      <div class="img-box">
                        <img class="img-responsive" src="{!!url('public/uploads/products/'.$data->images)!!}" onerror="this.src='public/default.jpg'" alt="img responsive">
                      </div>
                      <div class="img-slide">
                          ...
                          <div id="links">
                            @foreach($data->detail_img as $row)
                              <a href="{!!url('uploads/products/details/'.$row->images_url)!!}" title="{!!$data->name!!}" data-gallery>
                                  <img src="{!!url('public/uploads/products/details/'.$row->images_url)!!}" onerror="this.src='public/default.jpg'" alt="ả{!!$data->name!!}" width="30" height="40">
                              </a>
                            @endforeach                              
                          </div>
                  ...
                  <div class="table-responsive">
                    <div class="panel panel-default">        
                      ...
                      <div id="links">
                           @foreach($data->detail_img as $row)
                              <a href="{!!url('uploads/products/details/'.$row->images_url)!!}" title="{!!$data->name!!}" data-gallery>
                                  <img src="{!!url('public/uploads/products/details/'.$row->images_url)!!}" onerror="this.src='public/default.jpg'" alt="ả{!!$data->name!!}" width="23%" height="50%">
                              </a>
                            @endforeach
                      </div>
                        <!-- The Bootstrap Image Gallery lightbox, should be a child element of the document body -->
